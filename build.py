...
SECTOREN_LIJST = [
    ...
    ("retail", "Retail",
     "Winkels, supermarkten, winkelcentra en filiaalbedrijven: wisselend personeel, magazijn en kantoor achter de winkel, en meerdere vestigingen met één beheer. Een pas per medewerker; de filiaalmanager blokkeert een verloren pas zelf.",
