...
def bouw():
    ...
    intro = (f"Bel {tel()}, mail naar <a href=\"mailto:{esc(MAIL)}\">{esc(MAIL)}</a> of vul het formulier in; {esc(ADVISEUR_NAMEN)} neemt binnen {esc(REACTIE_AANVRAAG)} contact met u op. "
